...
pypy ocr-evaluation-strict.py /tmp/ocr-output-words-tesseract-all.tsv $EVAL_DIR eval-results-tess-all.txt

pypy ocr-evaluation-strict.py /tmp/ocr-output-words-cuneiform-all.tsv $EVAL_DIR eval-results-cuni-all.txt